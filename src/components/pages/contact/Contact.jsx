    ...
    return (
        <div className="contact-main">
            ...
            <Grid container className="contact-block">
                <Grid item xs={12} md={6} sm={12} className="contact-info-block">
                    <div data-aos="fade-right" data-aos-duration="1500" className="mobile c">
                        <img src={mobileIcon} alt="mobileIcon" />
                        <span>+91 9666983676</span>
                    </div>
                    <div data-aos="fade-left" data-aos-duration="1500" className="email c">
                    ...
                    <div data-aos="fade-right" data-aos-duration="1500" className="linkedInIcon c">
                        <img src={linkedInIcon} alt="linkedInIcon" />
                        <span>vamsi chilukuri </span>
                    </div>
                    <div data-aos="fade-left" data-aos-duration="1500" className="instagram c">
